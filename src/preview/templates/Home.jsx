                ...
                <Row>
                  <Col md={3}>
                    <div className="footer-bottom">
                      <svg
                        class="Footer-module--logo--3otJM"
                        fill="#f4f4f4"
                        width="81"
                        height="32"
